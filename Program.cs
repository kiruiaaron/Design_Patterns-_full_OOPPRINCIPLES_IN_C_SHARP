...
var p1 = new Person("Scott","Perez", new DateOnly(1970,1,1));
var p2 = new Person("Aron","Kirui", new DateOnly(1980,1,2));
 
p1.Pets.Add(new Dog("Fred"));
p1.Pets.Add(new Dog("Jeff"));

p2.Pets.Add(new Dog("james"));
p2.Pets.Add(new Cat("Ann"));
